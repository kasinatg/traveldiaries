...
class DiariesControllerTest < ActionController::TestCase
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post :create, diary: { content: @diary.content, diaryname: @diary.diaryname, keywords: @diary.keywords, published: @diary.published, status: @diary.status }
    end
  ...
  test "should update diary" do
    patch :update, id: @diary, diary: { content: @diary.content, diaryname: @diary.diaryname, keywords: @diary.keywords, published: @diary.published, status: @diary.status }
    assert_redirected_to diary_path(assigns(:diary))
  end
